    ...
    <div class="row">
      <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">Your order history</div>
            @if (count($orders) > 0)
              @foreach($orders as $order)
                <div class="panel-body">
                  <ul class="list-group">
                    <li class="list-group-item list-group-item-dark"><strong>Date and time: {{$order->created_at}}<br>Payment ID: {{$order->payment_id}}</strong></li>
            ...
            @else
              <div class="panel-body">
                <p class="label label-warning">No orders found</p></div>
              @endif
  </div>
            </div>
